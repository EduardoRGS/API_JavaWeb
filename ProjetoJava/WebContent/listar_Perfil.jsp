				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<button class="btn btn-danger" onclick="confimarExclusao(${p.idPerfil},'${p.nome}')">
							...
							<a class="btn btn-info" href="gerenciar_menu_perfil.do?acao=gerenciar&idPerfil=${p.idPerfil}">
								<i class="">Acessos</i>
